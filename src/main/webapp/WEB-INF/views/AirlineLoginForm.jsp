...
<title>Airline Login Screen</title>
</head>
<body>
	...
	<h2>Airline Login Screen</h2>
	<div>
	<a href="userLogout.htm">Home Page</a>
		<form id="airlineLoginForm" action="loginSuccessAirline.htm" method="POST">
			<table>
				<tr>
					<td>User Name:</td>
				...
				<tr>
					<td> <input type="submit" value="Airline Login" /> </td>
				</tr>
			</table>
		</form>
		<a href="signupSuccessAirline.htm">Airline Signup</a>
	</div>
</body>
</html>